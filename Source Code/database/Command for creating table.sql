...
(
    ...
    CONSTRAINT nation_key PRIMARY KEY (n_nationkey),
...
(
    ...
    p_contrainer character(10) COLLATE pg_catalog."default" NOT NULL,
    p_retailprice numeric(15,2) NOT NULL,
    p_comment character varying(23) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT part_key PRIMARY KEY (p_partkey)
)
WITH (
    OIDS = FALSE
)
...
(
    ...
    CONSTRAINT kf_ps_suppkey_partkey FOREIGN KEY (ps_partkey)
...
(
    ...
    CONSTRAINT customer_key PRIMARY KEY (c_custkey),
    CONSTRAINT kf_customer FOREIGN KEY (c_nationkey)
        REFERENCES public.nation (n_nationkey) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
(
    ...
    CONSTRAINT kf_orders FOREIGN KEY (o_custkey)
